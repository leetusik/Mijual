...
| [ ] `P4` | `in_progress` | `changes_requested` | Ship & Deploy | `P4.F10` | `works/phases/active/P4` |
...
| [ ] `P4.F10` | `todo` | Event page: render 이 마감 알림 받기 from the request's own session, not after GET /auth/me | `fix` | `works/phases/active/P4/slices/P4.F10` |
