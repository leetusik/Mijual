...
| [ ] `P4.F2` | `in_progress` | Cloudflare Web Analytics off: re-measure the no-third-party-origin property in a real browser, harden check_third_party, re-date the printed claim | `fix` | `works/phases/active/P4/slices/P4.F2` |
