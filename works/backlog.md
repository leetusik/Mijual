...
- Current slice: `P3.S6`
- Next slice: `P3.S7`
- Waiting on operator: `P3.S6`
- Open deferred jobs: `4`
- Rebuilt at: `2026-08-21T12:00:17+09:00`
...
| [~] `P3.S6` | `pending` | Design R5: 개인화 2층 — auth surfaces + portfolio 등록 + D-day list + sample load | `co-work` | `works/phases/active/P3/slices/P3.S6` |
