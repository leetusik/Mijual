...
| [~] `P11` | `pending` | `pending` | Ask agent polish: inline citations and feature cards | `P11.REVIEW` | `works/phases/active/P11` |
...
| [ ] `P11.REVIEW` | `in_progress` | phase review | `review` | `works/phases/active/P11/slices/P11.REVIEW` |
