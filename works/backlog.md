...
- Rebuilt at: `2026-08-22T19:25:53+09:00`
...
| [ ] `P6` | `planned` | `pending` | Apply — AI 질문 agent | `P6.S1` | `works/phases/active/P6` |
...
| [ ] `P6.S1` | `todo` | 익명 대화 저장소 + Conversations 포트 구현: schema, session hash, cursor reads, ops tabs live | `implementation` | `works/phases/active/P6/slices/P6.S1` |
| [ ] `P6.S2` | `todo` | The five agent tools: search_events / get_event / get_portfolio / save_feedback / get_contact | `implementation` | `works/phases/active/P6/slices/P6.S2` |
