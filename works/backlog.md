...
| [~] `P13` | `pending` | `pending` | Email verification at signup (6-digit code) | `P13.REVIEW` | `works/phases/active/P13` |
...
| [ ] `P13.REVIEW` | `in_progress` | phase review | `review` | `works/phases/active/P13/slices/P13.REVIEW` |
