...
| [ ] `P10` | `in_progress` | `changes_requested` | Rebrand to 주주의관제탑 | `P10.F3` | `works/phases/active/P10` |
...
| [ ] `P10.F3` | `in_progress` | 로고를 옆 글자에 맞춘다 — 바 중심 정렬을 텍스트 기준 정렬로 교체 | `fix` | `works/phases/active/P10/slices/P10.F3` |
