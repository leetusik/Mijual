...
- Rebuilt at: `2026-08-19T18:44:45+09:00`

## Active Phases

| Phase | Status | Review | Name | Current Slice | Path |
|---|---|---|---|---|---|
| [ ] `P1` | `planned` | `pending` | Foundation Spike & Confirmations | `P1.S3` | `works/phases/active/P1` |
...
| [ ] `P1.S3` | `todo` | Recon: daker.ai submission requirements + mijual domain availability | `research` | `works/phases/active/P1/slices/P1.S3` |
