...
| [ ] `P10` | `in_progress` | `changes_requested` | Rebrand to 주주의관제탑 | `P10.F2` | `works/phases/active/P10` |
...
| [ ] `P10.F2` | `todo` | R18 ②②b — nav·/ops 활성 탭이 형제를 밀지 않게 (폭 예약) | `fix` | `works/phases/active/P10/slices/P10.F2` |
