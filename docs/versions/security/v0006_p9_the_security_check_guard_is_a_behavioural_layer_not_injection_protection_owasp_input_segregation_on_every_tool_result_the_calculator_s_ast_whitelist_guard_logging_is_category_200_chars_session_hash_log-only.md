...
doc_id: security
version: v0006
created_at: 2026-08-25T08:55:46+09:00
source: P9.REVIEW
summary: P9 — the security_check guard is a behavioural layer, not injection protection; OWASP input segregation on every tool result; the calculator's AST whitelist; guard logging is category + 200 chars + session_hash, log-only
previous: v0005_p8_design_polish_pass_the_vocky_key_boundary_now_covers_a_capture_path_a_reader_s_free_text_leaves_the_system_by_design_with_no_contact_field_and_the_pii_inset_is_deleted_from_the_auth_screen_while_the_structural_guarantee_stands
---
...
미주얼 has **two of three legs absent**: the corpus is public DART filings and the reader is
