...
source: P8.REVIEW
summary: P8 design polish pass — POST /feedback (write-only, outward) and next_lapse.tie_count on GET /board/summary
previous: v0004_p7_fix_pass_get_stocks_suggest_the_reader_s_own_candidate_list_before_the_submit_declared_before_the_handle_route_the_miss_rule_restated_the_resolver_still_never_guesses
---
...
`next_lapse.tie_count` on `GET /board/summary`.** Every contract below is
