...
source: P8.REVIEW
summary: P8 design polish pass — mijual.web's outbound row is one vocky read plus one vocky capture, still in the single module the AST scan allows; suite baseline 142
previous: v0006_p7_fix_pass_the_suite_baseline_moves_to_139_and_mijual.web_gains_one_read-only_route
---
