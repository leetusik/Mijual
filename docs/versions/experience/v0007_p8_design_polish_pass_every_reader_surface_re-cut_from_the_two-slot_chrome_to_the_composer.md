...
doc_id: experience
version: v0007
created_at: 2026-08-24T23:44:16+09:00
source: P8.REVIEW
summary: P8 design polish pass — every reader surface re-cut, from the two-slot chrome to the 보내기 composer
previous: v0006_p7_fix_pass_the_two-slot_nav_the_board_s_30-row_window_candidates_while_typing_the_miss_rule_split_from_the_typing_rule_the_caption_s_narrower_stated_promise_and_the_flip_measured_on_the_running_product
---
...
- **Chrome.** Two nav destinations (AI 질문 · 보유 종목) — 관제 현황판 *is* the ring wordmark, so the
  ...
  the gate-cost and 면책 sentences are **dropped, not relocated**. 의견 보내기 is 미주알's own screen
