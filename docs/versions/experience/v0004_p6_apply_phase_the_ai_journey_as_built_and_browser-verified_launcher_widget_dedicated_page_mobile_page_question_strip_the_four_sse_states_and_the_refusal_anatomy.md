...
doc_id: experience
version: v0004
created_at: 2026-08-22T22:55:38+09:00
source: P6.REVIEW
summary: P6 apply phase: the AI 질문 journey as built and browser-verified — launcher, widget, dedicated page, mobile page, question strip, the four SSE states and the refusal anatomy
previous: v0003_p5_apply_phase_the_signed_journeys_as_built_and_what_each_surface_refuses_to_state_verified_in_a_real_browser
---
...
- **The agent prints raw contract numerals** (`3200원`) where every other surface formats them
  (`3,200원`), because the record tells it to quote the verified value as-is and formatting inside
  prose would be the agent transforming a number. Whether the *tool contract* should hand over
  presentation-formatted values is an open design question.
