...
doc_id: decisions
version: v0011
created_at: 2026-08-31T04:33:00+09:00
source: P10.REVIEW
summary: P10 round 2 — R17 signed and applied: the mark, the launcher and the favicon supersede R2/R6, the type moves to a self-hosted subset, and two record errors were corrected at apply time
previous: v0010_p10_rebrand_the_whole_latin_identity_is_superseded_by_with_no_romanized_replacement_the_dated_mijual_domain_fact_sheet_is_preserved_as_history
---
...
1. **The mark is replaced, not resized.** `juju2` supersedes the first delivery: the trimmed box is
   **1292×371** against 1213×319, and the Korean glyph band carries **2.3× the ink** (37.5 % coverage
