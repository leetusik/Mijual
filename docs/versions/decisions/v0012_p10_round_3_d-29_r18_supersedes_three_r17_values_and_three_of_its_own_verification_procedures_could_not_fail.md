...
doc_id: decisions
version: v0012
created_at: 2026-08-31T11:14:18+09:00
source: P10.REVIEW
summary: P10 round 3 — D-29: R18 supersedes three R17 values, and three of its own verification procedures could not fail
previous: v0011_p10_round_2_r17_signed_and_applied_the_mark_the_launcher_and_the_favicon_supersede_r2_r6_the_type_moves_to_a_self-hosted_subset_and_two_record_errors_were_corrected_at_apply_time
---
...
1. **The wordmark box `1292×371` → `1247×371`.** The artwork carried a quarter-em space between 「의」
   ...
   **70-column, full-height, zero-alpha band** (`x=519..588`, independently re-derived at
   ...
   source's. **Nothing vertical moved**, which is the point: `INK_OFFSET 0.2628·H`,
   `translateY(-7px)` / `-6px` and the measured h27 band centre **25.60** are unchanged.
