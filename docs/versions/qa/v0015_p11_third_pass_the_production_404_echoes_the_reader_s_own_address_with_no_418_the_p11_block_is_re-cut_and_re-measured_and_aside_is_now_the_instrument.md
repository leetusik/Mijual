...
doc_id: qa
version: v0015
created_at: 2026-09-01T03:28:12+09:00
source: P11.REVIEW
summary: P11 third pass: the production 404 echoes the reader's own address with no #418, the P11 block is re-cut and re-measured, and Aside is now the instrument
previous: v0014_p11_fixes_the_start-card_checklist_rows_are_re-cut_to_four_live-corpus_cards_the_footer_row_admits_the_operator_s_mono_phone_and_the_p11_block_gains_the_contact_fallback_and_dynamic-route_checks
---
...
- [ ] `pytest` green (**158**) and `workflow validate` clean. *(154 through P10; `P11.F1` added two
      `/ask/start-cards` cases and `P11.F2` two `/site/contact` ones.)*
