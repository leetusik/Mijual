...
doc_id: qa
version: v0011
created_at: 2026-08-31T11:13:14+09:00
source: P10.REVIEW
summary: P10 round 3: correct the two lines R18 falsified (1292x371, the opaque 84% tile) and append the round-3 block
previous: v0010_p10_round_2_the_rebrand_block_is_corrected_for_the_second_mark_and_the_shipped_favicon_and_six_r17_lines_are_added
---
...
- [ ] **세로 기하는 움직이지 않았다**: `INK_OFFSET_PX = {27: 7, 24: 6}`, `translateY(-7px)` / `-6px`,
      and the h27 glyph-band centre at **25.60** in the 51px content box — identical to the pre-R18
      measurement. R18 changed the horizontal only; a vertical difference is the regression (P10 round 3)
